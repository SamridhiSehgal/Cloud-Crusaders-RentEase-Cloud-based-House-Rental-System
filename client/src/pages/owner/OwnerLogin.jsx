...
const OwnerLoginPopup = ({ onClose }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        //naviagte to owner dashboard desgin the owner dashboard ma'am...think about it... what feature should be their and its graphic ui/ux....
        navigate('/owner/dashboard');
        console.log(isSignUp ? 'Owner Signing Up:' : 'Owner Logging In:', formData);
        onClose();
    };
