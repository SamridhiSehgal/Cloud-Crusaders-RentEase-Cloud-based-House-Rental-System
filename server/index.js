...
const ownerModel = require('./models/ownerModel'); //  path to your owner model

async function main() {
  try {
    // 1. Connect to MongoDB Atlas
    await mongoose.connect('mongodb+srv://RentEase_mongodb:rentease04@renteasecluster.fs68ztf.mongodb.net/RentEase?retryWrites=true&w=majority', {  //changed test to HouseRentalDB
